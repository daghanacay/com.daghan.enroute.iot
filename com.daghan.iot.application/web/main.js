...
(function() {
	...
	var MODULE = angular.module('com.daghan.iot',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/com.daghan.iot/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/com.daghan.iot/main/htm/about.htm'});
